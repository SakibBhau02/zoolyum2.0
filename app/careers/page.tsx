...
import { JOBS, JOB_DETAILS, HIRING_STEPS, CAREERS_FAQS, TEAM, SITE_URL } from "@/lib/data";
...
export default function CareersPage() {
  const jobPostingLd = {
    ...
    "@graph": JOBS.filter((j) => JOB_DETAILS[j.title]).map((j) => ({
      "@type": "JobPosting",
      title: j.title,
      description: `${JOB_DETAILS[j.title].about} Responsibilities: ${JOB_DETAILS[j.title].responsibilities.join("; ")}.`,
