...
import { POSTS, POST_FAQS, POST_UPDATED, SITE_URL } from "@/lib/data";
import { ARTICLE_BODIES, ARTICLE_SECTIONS } from "@/lib/posts-content";
...
export async function generateMetadata({
  ...
  const modified = POST_UPDATED[post.slug] ?? post.date;
  return {
    title: post.title,
...
export default async function BlogPostPage({
  ...
  const updated = POST_UPDATED[post.slug] ?? post.date;
            ...
            <Reveal delay={120}>
              <div className="mt-8 flex flex-wrap items-center justify-between gap-5 border-y border-olive/15 py-5">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="font-body text-sm font-medium text-ivory/85">{post.author}</p>
            ...
            <Reveal>
              <div className="card-surface mt-14 flex flex-col gap-5 p-7 sm:flex-row sm:items-center md:p-8">
                ...
                <div>
                  ...
                  <p className="mt-2 font-display text-xl font-semibold text-ivory">{post.author}</p>
