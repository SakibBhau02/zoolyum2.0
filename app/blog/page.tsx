...
import { POSTS, SITE_URL } from "@/lib/data";

export const metadata: Metadata = {
  title: "Insights - Strategy, Branding & Market Notes from Dhaka",
  description:
    "Field notes from the market: branding, positioning, growth marketing, design, and Bangladesh market trends - written by the strategists running the engagements, not by a content farm.",
  alternates: { canonical: "/blog" },
  openGraph: {
    title: "Zoolyum Insights - Field notes from the market",
    description:
      "Strategy, design, and market truth for people who read to lead.",
    url: "/blog",
  },
  ...
  twitter: {
    card: "summary",
    title: "Zoolyum Insights - Field notes from the market",
    description: "Strategy, design, and market truth for people who read to lead.",
  },};
