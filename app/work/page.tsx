...
export const metadata: Metadata = {
  ...
  description:
    "Case studies as positions held: education, healthcare, fashion retail, SaaS, F&B, hospitality, real estate, and e-commerce brands we've strengthened - every engagement with measured outcomes.",
  alternates: { canonical: "/work" },
  openGraph: {
    title: "Zoolyum Work - Case studies with measured outcomes",
    description:
      "Eight published positions held. Filter by industry or service - the numbers are precise on purpose.",
    url: "/work",
  },
  ...
  twitter: {
    card: "summary",
    title: "Zoolyum Work - Case studies with measured outcomes",
    description: "Eight published positions held. Filter by industry or service - the numbers are precise on purpose.",
  },};
