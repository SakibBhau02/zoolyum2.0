...
export async function generateMetadata(): Promise<Metadata> {
  return pageMeta("services", {
    ...
    description: "Five ways Zoolyum strengthens your market position: brand strategy, digital design & UI/UX, growth marketing, content strategy, and video production. Every service told as a story - the problem you're living with, what we do about it, and what you walk away holding.",
    canonical: "/services",
    ogTitle: "Zoolyum Services - Five ways to strengthen your position",
    ogDescription: "Brand strategy, digital design, growth marketing, content strategy, and video production - told as stories with proof.",
    card: "summary",
  });
}
