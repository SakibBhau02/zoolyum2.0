...
import { NEWSLETTER_BENEFITS as TS_BENEFITS } from "@/lib/data";
import { getPosts, getJsonSetting } from "@/lib/content";

export async function generateMetadata(): Promise<Metadata> {
  return pageMeta("newsletter", {
    ...
    ogTitle: "The Zoolyum Letter | Zoolyum",
    ogDescription: "One strategic insight a month. No noise. Market patterns, case teardowns, and frameworks from a Dhaka strategy studio.",
    card: "summary",
  });
}
        ...
        <div className="section-shell grid items-start gap-10 lg:grid-cols-12">
          <Reveal className="lg:col-span-7">
            <div data-lead-inline className="card-surface relative overflow-hidden p-8 md:p-10">
              ...
              <FormShell className="mt-8 space-y-5" leadKind="newsletter">
