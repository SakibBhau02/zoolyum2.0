...
import { getProjects, getTestimonials, getHomeCopy, getHomeStages, getHomeStats } from "@/lib/content";
...
export default async function Home() {
  const [projects, testimonials, home, stages, stats] = await Promise.all([getProjects(), getTestimonials(), getHomeCopy(), getHomeStages(), getHomeStats()]);
  const hero: HeroCopy = {
  ...
  const tagline: TaglineCopy = {
    openerA: home["home.tagline.openerA"] ?? "", openerB: home["home.tagline.openerB"] ?? "", openerSub: home["home.tagline.openerSub"] ?? "",
    act1sub: home["home.tagline.act1.sub"] ?? "", act1body: home["home.tagline.act1.body"] ?? "",
    act2sub: home["home.tagline.act2.sub"] ?? "", act2body: home["home.tagline.act2.body"] ?? "",
    act3sub: home["home.tagline.act3.sub"] ?? "", act3body: home["home.tagline.act3.body"] ?? "",
    lockupNote: home["home.tagline.lockupNote"] ?? "", cta: home["home.tagline.cta"] ?? "",
  };
  ...
  return (
    <>
      ...
      <IndustryTicker />
      <Chapter6Voices testimonials={testimonials} copy={voices} />
      <Chapter7CTA />
    </>
  );
}
