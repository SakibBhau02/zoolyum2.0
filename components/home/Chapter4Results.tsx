 ...
 */
export function Chapter4Results() {
  return (
    <section
      id="chapter-results"
      ...
      <div className="section-shell relative z-10">
        ...
        <Reveal>
          ...
          <h2 className="mt-4 max-w-2xl font-display text-display-2 font-semibold text-ivory">
            Proof, stated <span className="text-ivory/55">plainly.</span>
          </h2>
          <p className="body-copy mt-5 max-w-xl font-body text-lead text-ivory/60">
            Numbers from engagements we&apos;re allowed to name. Precise on
            purpose — vague claims are just noise.
          </p>
        </Reveal>
        ...
        <Reveal delay={150}>
          <p className="body-copy mt-14 max-w-lg font-body text-[15px] leading-relaxed text-ivory/55">
            Eight years in the Bangladesh market. One hundred twenty
            engagements across education, real estate, F&amp;B, and
